...
if __name__ == '__main__':
    ...
    # helper.create_insert_pixel()
    logger.info(f'create pixel done')
    ### Create models
    ...
    for epoch in range(helper.start_epoch, helper.params['epochs'] + 1, helper.params['aggr_epoch_interval']):
        ...
        elif helper.params['aggregation_methods'] == config.AGGR_GRAD_MEAN:
            is_updated, names= helper.average_grad(helper.target_model, updates)
